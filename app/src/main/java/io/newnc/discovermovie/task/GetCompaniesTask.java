 ...
 *      &format=json
 */
public class GetCompaniesTask extends AsyncTask<Integer, Void, String> {
    ...
    public void onPostExecute(String s) {
        ...
        try {
            if (s != null)
                AppController.getInstance().loadCompaniesFrom(new JSONArray(s));
            else
                log("null");
    ...
    private static final String CATEG = "GetCompaniesTask";
